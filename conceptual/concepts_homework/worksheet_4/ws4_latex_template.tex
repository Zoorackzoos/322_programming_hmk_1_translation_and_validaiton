...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \[
            \frac{
                \langle (eq\ 1\ 1),\ \rho \rangle \Downarrow true
                \quad
                \frac{
                    \langle true,\ \rho \rangle \Downarrow true
                    \quad
                    \text{no rule applies to } (+\ true\ 1)
                }{
                    \langle (var\ (x\ true)\ (if\ x\ (+\ x\ 1)\ 5)),\ \rho \rangle \ \text{stuck}
                }
            }{
                \langle (if\ (eq\ 1\ 1)\ (var\ (x\ true)\ (if\ x\ (+\ x\ 1)\ 5))\ 0),\ \rho \rangle \ \text{stuck}
            }
        \]
        ...
        \[
            \frac
            {
                \frac
                {
                    ...
                    {<(eq\ (-\ a\ b)\ 5)> \ \downarrow \ true}
                }
                {
                    <(and\ (lt\ b\ a)\ (eq\ (-\ a\ b)\ 5))> \ \downarrow \ true
                }
                \frac
                {
                    <b \ , \ p_0> \ \downarrow \ 5
                \ \ \
                    \frac
                    {<a , p_1>\ \downarrow \ 5 \ \ \ <b , p_1> \ \downarrow \ 5}
                    {<(+\ a\ b) \ , \ p_1> \ \downarrow \ 10}
                }
                {<(var\ (a\ b)\ (+\ a\ b), \ p_0)> \ \downarrow \ 10}
            }
            {\langle (if\ (and\ (lt\ b\ a)\ (eq\ (-\ a\ b)\ 5))\ (var\ (a\ b)\ (+\ a\ b))\ 0),\ \rho_0 \rangle \ \downarrow \ 10}
        \]
